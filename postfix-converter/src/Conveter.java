...
public class Conveter {
	...
	public static void main(String[] args) {
		...
		catch(NullPointerException e) //this will come from an operator trying to pull from an empty stack, or too many operands, or a missing left paren
		{
			System.out.println("Not A Vaild Expression");
		}
		catch(NumberFormatException e) //this will come from a missing right paren
		{
			System.out.println("Not A Vaild Expression");
		}
	...
	private static int evaluateExpression(String postfix) {
		...
		catch(NullPointerException e) // catches if there are too many operators
		{
			throw e;
		}	
	}
